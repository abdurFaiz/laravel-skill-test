...
export default function PostEdit({ post: { data: postData } }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Dashboard', href: '/dashboard' },
        { title: 'Posts', href: '/posts' },
        { title: postData.title, href: `/posts/${postData.id}` },
        { title: 'Edit', href: `/posts/${postData.id}/edit` },
    ];
